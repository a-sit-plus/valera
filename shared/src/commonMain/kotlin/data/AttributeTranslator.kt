    ...
    fun translate(attributeName: String): StringResource? {
        return when (credentialScheme) {
            ...
            is ConstantIndex.MobileDrivingLicence2023 -> when(attributeName) {
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.GIVEN_NAME}" -> Res.string.attribute_friendly_name_firstname
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.FAMILY_NAME}" -> Res.string.attribute_friendly_name_lastname
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.PORTRAIT}" -> Res.string.attribute_friendly_name_portrait
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.BIRTH_DATE}" -> Res.string.attribute_friendly_name_date_of_birth
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.AGE_OVER_18}" -> Res.string.attribute_friendly_name_age_at_least_18
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.RESIDENT_ADDRESS}" -> Res.string.attribute_friendly_name_main_address
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.RESIDENT_CITY}" -> Res.string.attribute_friendly_name_main_residence_city
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.RESIDENT_POSTAL_CODE}" -> Res.string.attribute_friendly_name_main_residence_postal_code
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.RESIDENT_COUNTRY}" -> Res.string.attribute_friendly_name_main_residence_country
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.RESIDENT_STATE}" -> Res.string.attribute_friendly_name_main_residence_state
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.NATIONALITY}" -> Res.string.attribute_friendly_name_nationality
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.AGE_IN_YEARS}" -> Res.string.attribute_friendly_name_age_in_years
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.AGE_BIRTH_YEAR}" -> Res.string.attribute_friendly_name_age_birth_year
                "${ConstantIndex.MobileDrivingLicence2023.isoNamespace}:${MobileDrivingLicenceDataElements.BIRTH_PLACE}" -> Res.string.attribute_friendly_name_birth_place
                else -> null
            }
