...
fun itemsToDocument(docType: String, namespace: String, entries: Set<StringResource>): Verifier.Document {
...
enum class DocumentAttributes(val value: String, val displayName: StringResource, val type: ValueType) {
