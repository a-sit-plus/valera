...
@Parcelize
actual class ConsentPage actual constructor(actual val claims: List<String>, actual val recipientName: String, actual val recipientLocation: String): Page, Parcelable
