/*
 * Source: Derived from CMWallet[https://github.com/digitalcredentialsdev/CMWallet] and adapted for this project.
 */
...
#include <stdint.h>
#include <unistd.h>
#include "../../matcher_common/cJSON.h"
...
int main() {
    ...
    AddStringIdEntry("0", icon_start, sizeof(_launcher_icon_png), "Valera", "Save your document to Valera", NULL, NULL);
