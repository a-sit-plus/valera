...
@OptIn(ExperimentalTestApi::class, ExperimentalStdlibApi::class)
class InstrumentedTests : FeatureSpec({
    runComposeUiTest {
        feature("givenNewAppInstallation_whenStartingApp_thenAppActuallyStarts") {
            setContent {
...
@OptIn(ExperimentalTestApi::class)
fun instrumentedTests() = featureSpec {
    ...
    feature ("givenNewAppInstallation_whenStartingApp_thenShowsOnboardingStartScreen") {
        // Start the app
        runComposeUiTest {
            setContent {
                val dummyDataStoreService = DummyDataStoreService()
    ...
    feature ("givenNewAppInstallation_whenStartingApp_thenShowsOnboardingStartButton") {
        // Start the app
        runComposeUiTest {
            setContent {
                val dummyDataStoreService = DummyDataStoreService()
    ...
    feature("givenNewAppInstallation_whenStartingApp_thenShowAttributesOnMyCredentialsScreen") {
        runComposeUiTest {
            setContent {
                //CompositionLocalProvider(LocalLifecycleOwner provides lifecycleOwner) {
                val dummyDataStoreService = DummyDataStoreService()
    ...
    feature("givenNewAppInstallation_whenStartingApp_thenLoadAttributesAndShowData") {
        runComposeUiTest {
...
class EndToEndTest {
    ...
    fun endToEndTest() {
        ...
        TestEngineLauncher(listener).withClasses(MyTestSuite::class).launch()
        listener.tests.map { entry ->
            {
                ...
                assertFalse(entry.value.isErrorOrFailure, """$descriptor
...
fun assertAll(assertions: List<() -> Unit>) {
